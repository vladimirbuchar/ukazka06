...
namespace Repository.CourseLectorRepository
{
    ...
    {
        public override HashSet<CourseLectorDbo> GetEntities(
            bool deleted,
            Expression<Func<CourseLectorDbo, bool>> predicate = null,
            Expression<Func<CourseLectorDbo, object>> orderBy = null,
            Expression<Func<CourseLectorDbo, object>> orderByDesc = null
        )
        {
            return
            [
