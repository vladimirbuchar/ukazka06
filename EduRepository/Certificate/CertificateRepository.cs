...
namespace Repository.Certificate
{
            ...
            ICertificateRepository
    {
        ...
        protected override IQueryable<CertificateDbo> PrepareDropDownQuery()
        {
            return _dbContext.Set<CertificateDbo>().Include(x => x.CertificateTranslations).ThenInclude(x => x.Culture);
        }
