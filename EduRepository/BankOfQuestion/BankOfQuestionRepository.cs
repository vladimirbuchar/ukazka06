...
namespace Repository.BankOfQuestion
{
            ...
            IBankOfQuestionRepository
    {
        ...
        protected override IQueryable<BankOfQuestionDbo> PrepareDropDownQuery()
        {
            return _dbContext.Set<BankOfQuestionDbo>().Include(x => x.BankOfQuestionsTranslations.Where(x => x.IsDeleted == false)).ThenInclude(x => x.Culture);
        }
    }
}
