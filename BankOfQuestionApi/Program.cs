...
void ConfigureServices(IServiceCollection services)
{
    ...
    RegisterBankOfQuestionService.RegisterService(services);
    ...
    _ = services.AddSwaggerGen(c =>
    {
        ...
        c.SwaggerDoc("BankOfQuestion", new Microsoft.OpenApi.Models.OpenApiInfo() { Title = "FlexibleLMS - bank of question ", Version = "v1" });
        c.MapEnumType(SortDirection.Ascending);
        c.MapEnumType(BankOfQuestionSort.Name);
        c.MapEnumType(QuestionSort.Question);
        c.MapEnumType(AnswerSort.Answer);
...
void Configure(IApplicationBuilder app, IWebHostEnvironment env)
{
    ...
    _ = app.UseSwaggerUI(c =>
    {
        ...
        c.SwaggerEndpoint("/swagger/BankOfQuestion/swagger.json", "FlexibleLMS API V1 - brank of question ");
