...
namespace EduApi.Migrations
{
    ...
    [Migration("20240124195039_AddCodebookCourseLessonItemTemplate")]
    partial class AddCodebookCourseLessonItemTemplate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Model.Tables.CodeBook.MessageTemplateTypeDbo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Model.Tables.Edu.Question.TestQuestionDbo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Model.Tables.Edu.Question.TestQuestionTranslationDbo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Model.Tables.Link.CourseStudentMaterialDbo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Model.Tables.Edu.CourseTerm.CourseTermDbo", b =>
                {
                    ...
                    b.HasOne("Model.Tables.CodeBook.TimeTableDbo", "TimeFrom")
                        .WithOne("CourseTermFrom")
                        .HasForeignKey("Model.Tables.Edu.CourseTerm.CourseTermDbo", "TimeFromId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Model.Tables.CodeBook.TimeTableDbo", "TimeTo")
                        .WithOne("CourseTermTo")
                        .HasForeignKey("Model.Tables.Edu.CourseTerm.CourseTermDbo", "TimeToId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("Model.Tables.Edu.CourseTermDate.CourseTermDateDbo", b =>
                {
                    ...
                    b.HasOne("Model.Tables.CodeBook.TimeTableDbo", "TimeFrom")
                        .WithOne("CourseTermDateFrom")
                        .HasForeignKey("Model.Tables.Edu.CourseTermDate.CourseTermDateDbo", "TimeFromId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Model.Tables.CodeBook.TimeTableDbo", "TimeTo")
                        .WithOne("CourseTermDateTo")
                        .HasForeignKey("Model.Tables.Edu.CourseTermDate.CourseTermDateDbo", "TimeToId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("Model.Tables.Edu.OrganizationStudyHour.OrganizationStudyHourDbo", b =>
                {
                    b.HasOne("Model.Tables.CodeBook.TimeTableDbo", "ActiveFrom")
                        .WithOne("OrganizationStudyHourFrom")
                        .HasForeignKey("Model.Tables.Edu.OrganizationStudyHour.OrganizationStudyHourDbo", "ActiveFromId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Model.Tables.CodeBook.TimeTableDbo", "ActiveTo")
                        .WithOne("OrganizationStudyHourTo")
                        .HasForeignKey("Model.Tables.Edu.OrganizationStudyHour.OrganizationStudyHourDbo", "ActiveToId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("Model.Tables.Edu.SendMessage.SendMessageDbo", b =>
                {
                    ...
                    b.HasOne("Model.Tables.CodeBook.MessageTemplateTypeDbo", "SendMessageType")
                        .WithMany()
            ...
            modelBuilder.Entity("Model.Tables.Edu.StudentTestSummaryQuestion.StudentTestSummaryQuestionDbo", b =>
                {
                    ...
                    b.HasOne("Model.Tables.Edu.Question.TestQuestionDbo", "Question")
