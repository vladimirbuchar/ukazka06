...
namespace EduApi.Migrations
{
    ...
    [Migration("20240814174759_DataMigrationEduMailPasswordReset")]
    partial class DataMigrationEduMailPasswordReset
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Model.CodeBook.EmailTypeDbo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Model.CodeBook.MessageTemplateTypeDbo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Model.Edu.AttendanceStudent.StudentAttendanceDbo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Model.Edu.Email.EmailDbo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Model.Edu.Email.EmailTranslationDbo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.HasIndex("EmailDboId");

                    b.HasIndex("SystemIdentificator")
                        .IsUnique()
                        .HasFilter("[SystemIdentificator] IS NOT NULL");

                    b.ToTable("Edu_EmailTranslation");
                });
            ...
            modelBuilder.Entity("Model.Edu.Message.MessageTemplateDbo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Model.Edu.Message.MessageTemplateTranslationDbo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Model.Link.CourseStudentMaterialDbo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Model.Edu.Course.CourseDbo", b =>
                {
                    ...
                    b.HasOne("Model.Edu.Message.MessageTemplateDbo", "SendMessage")
                        .WithMany()
            ...
            modelBuilder.Entity("Model.Edu.Email.EmailDbo", b =>
                {
                    b.HasOne("Model.CodeBook.EmailTypeDbo", "EmailType")
                        .WithMany()
            ...
            modelBuilder.Entity("Model.Edu.Email.EmailTranslationDbo", b =>
                {
                    ...
                    b.HasOne("Model.Edu.Email.EmailDbo", "EmailDbo")
                        .WithMany("EmailTranslations")
                        .HasForeignKey("EmailDboId");

                    b.Navigation("Culture");

                    b.Navigation("EmailDbo");
                });
            ...
            modelBuilder.Entity("Model.Edu.Message.MessageTemplateDbo", b =>
                {
                    ...
                    b.HasOne("Model.CodeBook.MessageTemplateTypeDbo", "SendMessageType")
                        .WithMany()
            ...
            modelBuilder.Entity("Model.Edu.Email.EmailDbo", b =>
                {
                    b.Navigation("EmailTranslations");
                });
