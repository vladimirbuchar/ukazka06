...
namespace EduApi.Controllers.ClientZone.Answer
{
    public class AnswerController : BaseClientZoneController
    {
        ...
        public ActionResult Create(AnswerCreateDto request)
        {
            try
            {
                CheckPermition(GetOrganizationByQuestion(request.QuestionId));
        ...
        public ActionResult List([FromQuery] ListDeletedRequestDto request)
        {
            try
            {
                CheckPermition(GetOrganizationByQuestion(request.ParentId));
        ...
        public ActionResult Detail([FromQuery] DetailRequestDto request)
        {
            try
            {
                CheckPermition(GetOrganizationByAnswer(request.Id));
        ...
        public ActionResult Delete([FromQuery] DeleteDto request)
        {
            ...
            {
                CheckPermition(GetOrganizationByAnswer(request.Id));
                _answerService.DeleteObject(request.Id, GetLoggedUserId());
                return SendResponse();
            }
            catch (Exception e)
            {
        ...
        public ActionResult Restore([FromQuery] RestoreDto request)
        {
            ...
            {
                CheckPermition(GetOrganizationByAnswer(request.Id));
                _answerService.RestoreObject(request.Id, GetLoggedUserId());
                return SendResponse();
            }
            catch (Exception e)
            {
        ...
        public ActionResult DeleteAnswerInQuestion([FromQuery] DeleteByParentIdDto request)
        {
            ...
            {
                CheckPermition(GetOrganizationByQuestion(request.ParentId));
                _answerService.MultipleDelete(x => x.TestQuestionId == request.ParentId, GetLoggedUserId());
                return SendResponse();
            }
            catch (Exception e)
            {
