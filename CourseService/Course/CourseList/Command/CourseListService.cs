...
using CourseService.Course.CourseList.Sort;
...
namespace CourseService.Course.CourseList.Command
{
    public class CourseListService
        : BaseListCommand<CourseDbo, ICourseRepository, CourseListDto, ICourseListConvertor, CourseFilter>,
            ICourseListService
    {
        public CourseListService(ICourseRepository repository, ICourseListConvertor convertor)
        ...
        protected override List<BaseSort<CourseDbo>> PrepareSort(
            string columnName,
            string culture,
        ...
        )
        {
            if (columnName == CourseSort.Name.ToString())
            {
                ...
                return [new BaseSort<CourseDbo>() { Sort = lambda, SortDirection = sortDirection }];
            }
            ...
            else if (columnName == CourseSort.Certificate.ToString())
            {
                ...
                MemberExpression courseMaterialTranslationProperty = Expression.Property(
                    courseMaterialProperty,
                ...
                MemberExpression systemIdentifcator = Expression.Property(
                    cultureProperty,
                    nameof(CertificateTranslationDbo.Culture.SystemIdentificator)
                );
            ...
            else if (columnName == CourseSort.CourseMaterial.ToString())
            {
                ...
                MemberExpression systemIdentifcator = Expression.Property(
                    cultureProperty,
                    nameof(CourseMaterialTranslationDbo.Culture.SystemIdentificator)
                );
            ...
            else if (columnName == CourseSort.SendMessage.ToString())
            {
                ...
                // Filtrujeme podle culture
                ParameterExpression translationParameter = Expression.Parameter(typeof(MessageTemplateTranslationDbo), "t");
                MemberExpression cultureProperty = Expression.Property(translationParameter, nameof(MessageTemplateTranslationDbo.Culture));
                MemberExpression systemIdentifcator = Expression.Property(cultureProperty, nameof(MessageTemplateTranslationDbo.Culture.SystemIdentificator));
                ...
                MethodCallExpression whereCall = Expression.Call(
                    ...
                    courseMaterialTranslationProperty,
                    Expression.Lambda<Func<MessageTemplateTranslationDbo, bool>>(cultureEqual, translationParameter)
                );
                ...
                MemberExpression nameProperty = Expression.Property(firstOrDefaultCall, nameof(MessageTemplateTranslationDbo.Subject));
