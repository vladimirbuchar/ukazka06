...
{
    public class CourseUpdateValidator : BaseUpdateValidator<CourseDbo, ICourseRepository, CourseUpdateDto>, ICourseUpdateValidator
    {
        ...
        public override async Task<Result> IsValid(CourseUpdateDto update)
        {
