...
void ConfigureServices(IServiceCollection services)
{
    ...
    _ = services.AddSwaggerGen(c =>
    {
        ...
        c.SwaggerDoc("Codebook", new Microsoft.OpenApi.Models.OpenApiInfo() { Title = "FlexibleLMS - codebook", Version = "v1" });
...
void Configure(IApplicationBuilder app, IWebHostEnvironment env)
{
    ...
    _ = app.UseSwaggerUI(c =>
    {
        ...
        c.SwaggerEndpoint("/swagger/Codebook/swagger.json", "FlexibleLMS API V1 - codebook");
