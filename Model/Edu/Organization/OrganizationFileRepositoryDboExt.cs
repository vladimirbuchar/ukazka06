...
namespace Model.Edu.Organization
{
    ...
    {
        public static OrganizationFileRepositoryDbo FindTranslation(this ICollection<OrganizationFileRepositoryDbo> translations, string culture, bool findSpecificCulture = false)
        {
